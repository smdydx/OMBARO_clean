  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-0">
        ...
        <section className="relative min-h-[500px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 pt-24 sm:pt-28 md:pt-32">
