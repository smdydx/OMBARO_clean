...
const categories = [
  {
    title: "Luxury Spa",
    description:
      "Indulge in ultimate relaxation and rejuvenation with our premium spa treatments.",
    image:
  ...
  },
  {
    title: "Bridal Beauty",
    description:
      "Look your best on your special day with our expert bridal makeup and styling services.",
    image:
  ...
  },
  {
    title: "Hair & Styling",
    description:
      "Transform your look with our professional hair salon services, from cuts to color and more.",
    image:
  ...
  const features = [
    {
      ...
      description:
        "Discover premium salons, spas, and wellness centers in your area with our smart location-based search.",
    },
    {
      icon: Star, // Changed from Clock to Star
      title: "Easy Booking",
      description:
        "Book appointments in seconds with our intuitive booking system. No phone calls needed.",
    },
    {
      icon: Star, // Changed from Star to Star
      title: "Verified Professionals",
      description:
        "All our partner professionals are verified, certified, and highly rated by customers.",
    },
    {
  ...
  const services = [
    {
      ...
      description:
        "Indulge in our premium spa treatments designed to rejuvenate your body and mind. Experience tranquility like never before.",
    ...
    },
    {
      ...
      description:
        "Expert therapeutic massages that relieve stress, ease muscle tension, and promote overall wellness and relaxation.",
    ...
    },
    {
      ...
      description:
        "Immerse yourself in our luxurious hot tub facilities, perfect for unwinding and soothing tired muscles.",
    ...
    },
    {
      ...
      description:
        "Comprehensive beauty and wellness services tailored to enhance your natural beauty and boost your confidence.",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "OMBARO has made booking spa appointments so easy! The therapists are professional and the service is always top-notch.",
    },
    {
      name: "Rahul Verma",
      ...
      rating: 5,
      comment:
        "As a busy professional, I love how convenient it is to book wellness services on the go. Highly recommended!",
    },
    {
      name: "Anjali Reddy",
      ...
      rating: 5,
      comment:
        "The quality of service providers on OMBARO is exceptional. I have found my go-to spa and salon through this platform.",
    },
  ];
      ...
      <main className="transition-all duration-700 ease-in-out">
            ...
            >
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    style={{ stopColor: "#00FF87", stopOpacity: 0.2 }}
                  />
                  <stop
                    offset="50%"
                    style={{ stopColor: "#016B3A", stopOpacity: 0.3 }}
                  />
                  <stop
                    offset="100%"
        ...
        <section className="relative py-12 md:py-20 overflow-hidden bg-gradient-to-b from-white via-primary-50 to-white mt-4 md:mt-0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              className={`grid lg:grid-cols-2 gap-12 items-center ${services[0].reverse ? "lg:grid-flow-dense" : ""}`}
            >
              ...
              {/* Content */}
              <div
                className={`${services[0].reverse ? "lg:col-start-1 lg:row-start-1" : ""} text-center lg:text-left`}
              >
              ...
              >
                <defs>
                  ...
                  >
                    <stop
                      offset="0%"
                      style={{ stopColor: "#00FF87", stopOpacity: 0.3 }}
                    />
                    <stop
                      offset="50%"
                      style={{ stopColor: "#016B3A", stopOpacity: 0.4 }}
                    />
                    <stop
                      offset="100%"
        ...
        {services.slice(1).map((service, index) => (
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div
                className={`grid lg:grid-cols-2 gap-12 items-center ${service.reverse ? "lg:grid-flow-dense" : ""}`}
              >
                {/* Image with Painted Frame */}
                ...
                {/* Content */}
                <div
                  className={`${service.reverse ? "lg:col-start-1 lg:row-start-1" : ""} text-center lg:text-left`}
                >
                  <div className="text-sm font-semibold text-primary-600 tracking-wider mb-3">
                    {service.subtitle}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-light text-gray-800 mb-4">
                Explore Our{" "}
                <span className="font-normal text-primary-600">Services</span>
              </h2>
        ...
        <section className="relative py-20 bg-gradient-to-b from-primary-50 via-white to-white overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-24">
            ...
            >
              ...
              <path
                fill="url(#waveGreenTop)"
                fillOpacity="1"
                d="M0,64L48,85.3C96,107,192,149,288,154.7C384,160,480,128,576,122.7C672,117,768,139,864,154.7C960,171,1056,181,1152,176C1248,171,1344,149,1392,138.7L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
              ></path>
            </svg>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-gradient-to-br from-primary-50 to-white rounded-3xl p-12 shadow-xl">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Join thousands of customers who have transformed their beauty
                routine with OMBARO
              </p>
