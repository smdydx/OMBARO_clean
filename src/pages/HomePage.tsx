          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center mb-8 sm:mb-10">
              <div className="space-y-4 sm:space-y-6 w-full px-2 sm:px-0">
                <h1
                  className="text-6xl sm:text-7xl md:text-6xl lg:text-6xl xl:text-[4rem] font-normal leading-tight w-full bg-gradient-to-r from-emerald-800 via-emerald-600 via-white to-emerald-900 bg-clip-text text-transparent"
